...
public class Board extends JPanel implements Runnable, Constants {
    ...
    private String songOne = "One.wav";
    private String songTwo = "Two.wav";
    private String songThree = "Three.wav";
    private String songFour = "Four.wav";
    private String songFive = "Five.wav";
    private String songSix = "Six.wav";
    private String songSeven = "Seven.wav";
    private String songEight = "Eight.wav";
    private String songNine = "Nine.wav";
    private String songTen = "Ten.wav";
